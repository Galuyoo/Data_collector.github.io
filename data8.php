...
<p class="chart-title">Comparison LED1 and LED2 "Battery_Voltage"</p>
  <div id="chart1">
  <script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
    ...
    const Battery_Voltage1 = <?php echo json_encode($Battery_Voltage1);?>;

    const Battery_Voltage_Threshold = <?php echo json_encode($Battery_Voltage_Threshold);?>;
    const Battery_Voltage_Threshold1 = <?php echo json_encode($Battery_Voltage_Threshold1);?>;
  ...
  series: [
    {
      name: "Battery_Voltage LED2",
      data: Battery_Voltage
    },
    {
      name: "Battery_Voltage LED1",
      data: Battery_Voltage1
    }
  ],
  stroke: {
...
<div class="charts-card">
<p class="chart-title">Comparison LED1 and LED2 "Battery_Voltage_Threshold"</p>
  <div id="chart2">
  <script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
    <script>
    var options = {
  ...
  series: [
    {
      name: "Battery_Voltage_Threshold LED2",
      data: Battery_Voltage_Threshold
    },
    {
      name: "Battery_Voltage_Threshold LED1",
      data: Battery_Voltage_Threshold1
    }
  ],
  stroke: {
    width: [4, 4, 4]             /*comparéson 2*/
