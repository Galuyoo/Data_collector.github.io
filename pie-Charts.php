...
<p class="chart-title">Comparison LED1 and LED2 remaining_gridcharge_capacity</p>
  <div id="chart1">
  ...
  series: [
    ...
    {
      name: "remaining_gridcharge_capacity LED1",
...
<div class="charts-card">
<p class="chart-title">Comparison LED1 and LED2 remaining_battery_capacity</p>
  <div id="chart2">
  <script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
    <script>
    var options = {
