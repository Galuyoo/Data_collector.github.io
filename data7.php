...
<p class="chart-title">Comparison LED1 and LED2 "cwr_statemachine_state"</p>
  <div id="chart1">
  <script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
    ...
    const MPP_statemachine_event1 = <?php echo json_encode($MPP_statemachine_event1);?>;
    const cwr_statemachine_state = <?php echo json_encode($cwr_statemachine_state);?>;
    const cwr_statemachine_state1 = <?php echo json_encode($cwr_statemachine_state1);?>;  
  ...
  series: [
    {
      name: "cwr_statemachine_state LED2",
      data: cwr_statemachine_state
    },
    {
      name: "cwr_statemachine_state LED1",
      data: cwr_statemachine_state1
    }
  ],
  stroke: {
...
<div class="charts-card">
<p class="chart-title">Comparison LED1 and LED2 "MPP_statemachine_event"</p>
  <div id="chart2">
  <script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
    <script>
    var options = {
  ...
  series: [
    {
      name: "MPP_statemachine_event LED2",
      data: MPP_statemachine_event
    },
    {
      name: "MPP_statemachine_event LED1",
      data: MPP_statemachine_event1
    }
  ],
  stroke: {
    width: [4, 4, 4]             /*comparéson 2*/
