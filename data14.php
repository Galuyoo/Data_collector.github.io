...
<p class="chart-title">Comparison LED1 and LED2 "Load_2_State"</p>
  <div id="chart1">
  <script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
    ...
    const Load_1_State1 = <?php echo json_encode($Load_1_State1);?>;
    ...
    const Load_2_State1 = <?php echo json_encode($Load_2_State1);?>;
  ...
  series: [
    {
      name: "Load_2_State LED2",
      data: Load_2_State
    },
    {
      name: "Load_2_State LED1",
      data: Load_2_State1
    },
  ],
  stroke: {
...
<div class="charts-card">
<p class="chart-title">Comparison LED1 and LED2 "Load_1_State"</p>
  <div id="chart2">
  <script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
    <script>
    var options = {
  ...
  series: [
    {
      name: "Load_1_State LED2",
      data: Load_1_State
    },
    {
      name: "Load_1_State LED1",
      data: Load_1_State1
    },
  ],
  stroke: {
