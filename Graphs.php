...
<p class="chart-title">Comparison LED1 and LED2 Load_current</p>
  <div id="chart1">
  ...
  series: [
    {
      name: "Load_current LED2",
      data: Load_current
    },
    {
      name: "Load_current LED1",
      data: Load_current1
    }
  ],
  stroke: {
...
<div class="charts-card">
<p class="chart-title">Comparison LED1 and LED2 Chargecurrent</p>
  <div id="chart2">
  <script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
    <script>
    var options = {
...
<div>
<div class="charts-card">
<p class="chart-title">Comparison LED1 and LED2 Charge_State</p>
  <div id="chart3">
  <script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
    <script>
    var options = {
  ...
  series: [
    {
      name: "Charge_State LED2",
      data: Charge_State
    },
    {
      name: "Charge_State LED1",
      data: Charge_State1
    }
  ],
  stroke: {
