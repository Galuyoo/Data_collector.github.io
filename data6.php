...
<p class="chart-title">Comparison LED1 and LED2 "recharged_by_AC_grid_counter"</p>
  <div id="chart1">
  <script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
    ...
    const recharged_by_AC_grid_counter1 = <?php echo json_encode($recharged_by_AC_grid_counter1);?>;
  ...
  series: [
    {
      name: "recharged_by_AC_grid_counter LED2",
      data: recharged_by_AC_grid_counter
    },
    {
      name: "recharged_by_AC_grid_counter LED1",
      data: recharged_by_AC_grid_counter
    },
  ],
  stroke: {
