...
<p class="chart-title">Comparison LED1 and LED2 PV_Voltage</p>
  <div id="chart1">
  <script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
    ...
    const PV_Voltage_goal1 = <?php echo json_encode($PV_Voltage_goal1);?>;
...
<div class="charts-card">
<p class="chart-title">Comparison LED1 and LED2 PV_Voltage_goal</p>
  <div id="chart2">
  <script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
    <script>
    var options = {
  ...
  series: [
    {
      name: "PV_Voltage_goal LED2",
      data: PV_Voltage_goal
    },
    {
      name: "PV_Voltage_goal LED1",
      data: PV_Voltage_goal1
    }
  ],
  stroke: {
    width: [4, 4, 4]             /*comparéson 2*/
