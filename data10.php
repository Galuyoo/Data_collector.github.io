...
<p class="chart-title">Comparison LED1 and LED2 "external_Temperature"</p>
  <div id="chart2">
  <script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
    ...
    const internal_Temperature1 = <?php echo json_encode($internal_Temperature1);?>;

    const external_Temperature = <?php echo json_encode($external_Temperature);?>;
    const external_Temperature1 = <?php echo json_encode($external_Temperature1);?>;
  ...
  series: [
    {
      name: "external_Temperature LED2",
      data: external_Temperature
    },
    {
      name: "external_Temperature LED1",
      data: external_Temperature1
    }
  ],
  stroke: {
...
<p class="chart-title">Comparison LED1 and LED2 "external_Temperature"</p>
  ...
  series: [
    {
      name: "internal_Temperature LED2",
      data: internal_Temperature
    },
    {
      name: "internal_Temperature LED1",
      data: internal_Temperature1
    }
  ],
  stroke: {
    width: [4, 4, 4]             /*comparéson 2*/
