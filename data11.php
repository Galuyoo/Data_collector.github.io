...
<p class="chart-title">Comparison LED1 and LED2 "FET_Temperature"</p>
  <div id="chart1">
  <script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
    ...
    const FET_Temperature1 = <?php echo json_encode($FET_Temperature1);?>;
  ...
  series: [
    {
      name: "FET_Temperature LED2",
      data: FET_Temperature
    },
    {
      name: "FET_Temperature LED1",
      data: FET_Temperature1
    },
  ],
  stroke: {
