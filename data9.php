...
<p class="chart-title">Comparison LED1 and LED2 "Daylength"</p>
  <div id="chart1">
  <script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
    ...
    const Nightlength1 = <?php echo json_encode($Nightlength1);?>;
    const Average_Nightlength = <?php echo json_encode($Average_Nightlength);?>;
    const Average_Nightlength1 = <?php echo json_encode($Average_Nightlength1);?>;
    ...
    const Charge_State1 = <?php echo json_encode($Charge_State1);?>;
...
<div class="charts-card">
<p class="chart-title">Comparison LED1 and LED2 "Nightlength"</p>
  <div id="chart2">
  <script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
    <script>
    var options = {
  ...
  series: [
    {
      name: "Nightlength LED2",
      data: Nightlength
    },
    {
      name: "Nightlength LED1",
      data: Nightlength1
    }
  ],
  stroke: {
...
<div>
<div class="charts-card">
<p class="chart-title">Comparison LED1 and LED2 "Average_Nightlength"</p>
  <div id="chart3">
  <script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
    <script>
    var options = {
  ...
  series: [
    {
      name: "Average_Nightlength LED2",
      data: Average_Nightlength
    },
    {
      name: "Average_Nightlength LED1",
      data: Average_Nightlength1
    }
  ],
  stroke: {
    width: [4, 4, 4]             /*comparéson 2*/
